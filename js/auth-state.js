    ...
    function updateUserInfo() {
        ...
        if (isLoggedIn()) {
            ...
            if (loginBtn) {
                ...
                // 요금제에 따른 색상
                let planColor = '#FFD700'; // Free 기본 색상
                if (currentPlan === '학생') {
                    planColor = '#14B8A6';
                } else if (currentPlan === '일반') {
                    planColor = '#3B82F6';
                } else if (currentPlan === '프로') {
                    planColor = '#8B5CF6';
                }
                
                userInfoEl.innerHTML = `<span class="user-plan-badge" style="background: ${planColor}; color: white; padding: 4px 10px; border-radius: 12px; font-size: 12px; font-weight: 600; margin-right: 8px;">${currentPlan}</span><span style="color: #333; font-size: 14px;">${userName}님</span><i class="fas fa-chevron-down" style="margin-left: 6px; font-size: 10px; color: #666;"></i>`;
                ...
                dropdown.innerHTML = `
                    <div class="user-dropdown-header">
                        <span class="user-plan-badge" style="background: ${planColor}; color: white; padding: 6px 14px; border-radius: 14px; font-size: 13px; font-weight: 600;">${currentPlan}</span>
